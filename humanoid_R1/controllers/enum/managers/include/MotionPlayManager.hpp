...
#ifndef MOTION_PLAY_MANAGER_HPP
#define MOTION_PLAY_MANAGER_HPP
...
namespace managers {
  ...
  public:
    MotionPlayManager(webots::Robot *robot, const std::string &customMotionFile = "");
    virtual ~MotionPlayManager();
